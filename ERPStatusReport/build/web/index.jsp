...
<%@page contentType="text/html" pageEncoding="UTF-8"
        import="de.di.erpconnect.ERPConnect,de.di.erpconnect.Info,de.di.erpconnect.web.ConnectorServlet" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
    "http://www.w3.org/TR/html4/loose.dtd">
<fmt:bundle basename="de.di.erpconnect.web.resource.servlet">
    <html>
        <head>
            ...
            <%
                ERPConnect connector = (ERPConnect) application.getAttribute(ConnectorServlet.connectorAttribute);
                if (connector != null && connector.isAlive()) {
                    java.util.Set<String> files = connector.getOpenFiles();
                    java.util.Map<String, String> status = connector.getStatus();

                    String productname = status.get("product_name");

                    if (ERPConnect.running) {
            %>
            ...
            <table class="status">
                ...
                <tr>
                    <td class="name"><fmt:message key="system.properties.clients.text" ></fmt:message></td><td class="value"><%= status.get("client_count")%></td>
                </tr>
                <tr>
                    <td class="name"><fmt:message key="system.properties.numberofdocument.perrun" ></fmt:message></td><td class="value"><%= status.get("Basic.MaxFilesPerRun")%></td>
                </tr>
                ...
                <tr>
                    <td class="name"><fmt:message key="system.properties.count.error" ></fmt:message></td><td class="value"><%= Info.getCounterError() %></td>
                </tr>
                <tr>
            ...
            <table>
                <tr>    
                    ...
                    <td valign="middle">
                        <%  java.util.List<String> errorStatus = ConnectorServlet.errorStatus;
            ...
            <% application.removeAttribute(ConnectorServlet.connectorAttribute); }%>
