...
<%@page contentType="text/html" pageEncoding="UTF-8"
        import="de.di.erpconnect.ERPConnect,de.di.erpconnect.web.ConnectorServlet" %>
...
<%
            ERPConnect importer = (ERPConnect) application.getAttribute(ConnectorServlet.connectorAttribute);
...
<tr>    
        ...
        <td> 
            <div class="name"><fmt:message key="page.licence.header.text"></fmt:message> <b>DOK</b>inform<sup>&#174;</sup> <b>ERP</b><i>connector</i></div>
        </td>
    </tr>
	</table>
<hr>
